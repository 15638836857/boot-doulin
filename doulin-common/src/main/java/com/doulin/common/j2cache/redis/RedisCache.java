package com.doulin.common.j2cache.redis;

import com.doulin.common.j2cache.Cache;
import com.doulin.common.j2cache.CacheException;
import com.doulin.common.j2cache.J2Cache;
import com.doulin.common.j2cache.util.SerializationUtils;
...
public class RedisCache implements Cache {
    ...
    public Long incr(Object key,Integer expireInSec) throws CacheException {
    	if (null == key)
    		return null;
    	Long b = null;
    	try {
    		b = redisCacheProxy.incr(getKeyName(key),expireInSec);
    	} catch (Exception e) {
    		log.error("Error occured when get data from redis2 cache", e);
    		if (e instanceof IOException || e instanceof NullPointerException)
    			evict(key);
