...
import com.doulin.common.j2cache.ehcache.EhCacheProvider;
...
public class CacheManager {
	 ...
	 * @return Cache object
	 */
	public final static Long incr(int level, String name, Object key, Integer expireInSec){
		//System.out.println("GET1 => " + name+":"+key);
		if(name!=null && key != null) {
			Cache cache = _GetCache(level, name, false);
			if (cache != null)
				return cache.incr(key,expireInSec);
		}
		return null;
	}
