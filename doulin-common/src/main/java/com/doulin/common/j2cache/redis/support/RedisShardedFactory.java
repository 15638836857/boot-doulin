package com.doulin.common.j2cache.redis.support;

import com.doulin.common.j2cache.redis.client.ShardedRedisClient;
...
public class RedisShardedFactory implements RedisClientFactory<ShardedRedisClient> {
    ...
    public void build() {
        ...
        String auth = this.poolConfig.getPassword();
        if (host != null) {
