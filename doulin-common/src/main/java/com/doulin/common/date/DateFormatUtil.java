package com.doulin.common.date;

import com.doulin.common.annotation.NotNull;
...
public class DateFormatUtil {
	...
	public static final String PATTERN_DEFAULT_ON_SECONDS = "yyyy-MM-dd HH:mm";
	...
	public static final FastDateFormat DEFAULT_ON_SECOND_FORMATS = FastDateFormat.getInstance(PATTERN_DEFAULT_ON_SECONDS);
